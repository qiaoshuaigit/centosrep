            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="logForm" action="${ctx}/perm/addPerm" accept-charset="UTF-8">
                            <div class="form-group">
                                <label for="permcode" class="col-sm-2 control-label">权限代码:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="permcode" name="code"
                                           placeholder="请输入名字">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="permname" class="col-sm-2 control-label">权限名称:</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="permission" class="col-sm-2 control-label">路径:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="permission" name="permiss"
                                           placeholder="请输入名字">
                                </div>
                            </div>
                            <div class="form-group">
